...
public sealed partial class FigmaTools
{
    [McpServerTool(
        ...
        Destructive = false,
        OpenWorld = false)]
    [Description("Report the Figma Design capabilities and limits available on one live connector.")]
    ...
    [McpServerTool(
        ...
        Destructive = false,
        OpenWorld = false)]
    [Description("Fetch up to 100 nodes by ID with an explicit field projection and bounded children.")]
    ...
    [McpServerTool(
        ...
        Destructive = false,
        OpenWorld = false)]
    [Description("Read transforms, bounds, paints, vectors, corners, constraints, and layout geometry.")]
    ...
    public Task<object> GetFigmaText(
        [Description("The live Figma plugin connection UUID.")] string connection_id,
        [Description("Object with node_ids and optional start, end, and segment_fields.")] JsonElement input,
        CancellationToken cancellationToken) =>
    ...
    public Task<object> GetFigmaPluginData(
        [Description("The live Figma plugin connection UUID.")] string connection_id,
        [Description("Object with node_ids and optional keys and shared_namespaces.")] JsonElement input,
        CancellationToken cancellationToken) =>
    ...
    [McpServerTool(
        ...
        Destructive = false,
        OpenWorld = false)]
    [Description("Read public annotations, measurements, dev status, and dev resources when available.")]
