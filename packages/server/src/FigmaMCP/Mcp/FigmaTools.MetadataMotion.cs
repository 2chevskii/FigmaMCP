...
{
    [McpServerTool(
        Name = "set_figma_plugin_data",
        Title = "Set Figma plugin data",
        Destructive = false,
        Idempotent = true,
        OpenWorld = false
    )]
    ...
    [McpServerTool(
        Name = "list_figma_annotation_categories",
        Title = "List Figma annotation categories",
        ReadOnly = true,
        Destructive = false,
        OpenWorld = false
    )]
    ...
    [McpServerTool(
        Name = "create_figma_annotation_category",
        Title = "Create Figma annotation category",
        Destructive = false,
        Idempotent = false,
        OpenWorld = false
    )]
    ...
    [McpServerTool(
        Name = "set_figma_annotations",
        Title = "Set Figma annotations",
        Destructive = false,
        Idempotent = true,
        OpenWorld = false
    )]
    ...
    public Task<object> SetFigmaAnnotations(
        [Description("The live Figma plugin connection UUID.")] string connection_id,
        [Description("Object with items containing node_id and annotations.")] JsonElement input,
        CancellationToken cancellationToken
    ) => InvokeAsync(connection_id, "set_figma_annotations", input, cancellationToken);

    [McpServerTool(
        Name = "manage_figma_measurements",
        Title = "Manage Figma measurements",
        Destructive = true,
        Idempotent = true,
        OpenWorld = false
    )]
    ...
    [McpServerTool(
        Name = "manage_figma_dev_resources",
        Title = "Manage Figma dev resources",
        Destructive = true,
        Idempotent = true,
        OpenWorld = true
    )]
    ...
    [McpServerTool(
        Name = "set_figma_dev_status",
        Title = "Set Figma dev status",
        Destructive = false,
        Idempotent = true,
        OpenWorld = false
    )]
    ...
    [McpServerTool(
        Name = "list_figma_animation_styles",
        Title = "List Figma Motion styles",
        ReadOnly = true,
        Destructive = false,
        OpenWorld = false
    )]
    ...
    [McpServerTool(
        Name = "get_figma_motion",
        Title = "Get Figma Motion",
        ReadOnly = true,
        Destructive = false,
        OpenWorld = false
    )]
    ...
    [McpServerTool(
        Name = "update_figma_motion",
        Title = "Update Figma Motion",
        Destructive = false,
        Idempotent = true,
        OpenWorld = false
    )]
