...
{
    [McpServerTool(Name = "list_figma_styles", Title = "List Figma styles", ReadOnly = true,
    ...
    [McpServerTool(Name = "create_figma_style", Title = "Create Figma style",
    ...
    [McpServerTool(Name = "update_figma_style", Title = "Update Figma style",
    ...
    [McpServerTool(Name = "delete_figma_style", Title = "Delete Figma style",
    ...
    [McpServerTool(Name = "reorder_figma_styles", Title = "Reorder Figma styles",
        Destructive = false, Idempotent = true, OpenWorld = false)]
    ...
    [McpServerTool(Name = "list_figma_style_consumers", Title = "List Figma style consumers",
    ...
    [McpServerTool(Name = "list_figma_variables", Title = "List Figma variables",
        ReadOnly = true, Destructive = false, OpenWorld = false)]
    ...
    [McpServerTool(Name = "create_figma_variable_collection",
        Title = "Create Figma variable collection", Destructive = false, Idempotent = false,
        OpenWorld = false)]
    ...
    [McpServerTool(Name = "create_figma_variable", Title = "Create Figma variable",
        Destructive = false, Idempotent = false, OpenWorld = false)]
    [Description("Create a variable with values, aliases, scopes, and code syntax.")]
    public Task<object> CreateFigmaVariable(
        [Description("The live Figma plugin connection UUID.")] string connection_id,
        [Description("Object with collection_id, name, resolved_type, and optional variable fields.")]
        JsonElement input,
        CancellationToken cancellationToken) =>
        InvokeAsync(connection_id, "create_figma_variable", input, cancellationToken);

    [McpServerTool(Name = "update_figma_variable", Title = "Update Figma variable",
        Destructive = false, Idempotent = true, OpenWorld = false)]
    ...
    [McpServerTool(Name = "delete_figma_variable", Title = "Delete Figma variable",
        Destructive = true, Idempotent = true, OpenWorld = false)]
    ...
    [McpServerTool(Name = "bind_figma_variable", Title = "Bind Figma variable",
        Destructive = false, Idempotent = true, OpenWorld = false)]
    [Description("Bind or unbind variables on nodes, text ranges, paints, effects, and layout grids.")]
    ...
    [McpServerTool(Name = "list_figma_team_library_assets",
        Title = "List or import Figma library assets", ReadOnly = false, Destructive = false,
        Idempotent = true, OpenWorld = false)]
    [Description("List enabled library variables or import a component, set, style, or variable by key.")]
