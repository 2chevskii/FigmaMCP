...
public sealed partial class FigmaTools
{
    ...
    [Description(
        "Replace, insert, delete, or format text after automatically loading required fonts."
    )]
    ...
    [Description(
        "Create an instance from a component or convert an existing scene node to a component."
    )]
    ...
    [Description(
        "Swap components, set properties, clear overrides, expose, scale, or detach instances."
    )]
    public Task<object> UpdateFigmaInstance(
        [Description("The live Figma plugin connection UUID.")] string connection_id,
        [Description("Object with instance items and explicit operations.")] JsonElement input,
        CancellationToken cancellationToken
    ...
    public Task<object> UpdateFigmaSlot(
        [Description("The live Figma plugin connection UUID.")] string connection_id,
        [Description("Object with operation and component_id or slot_id.")] JsonElement input,
        CancellationToken cancellationToken
    ...
    public Task<object> ListFigmaComponentInstances(
        [Description("The live Figma plugin connection UUID.")] string connection_id,
        [Description("Object with component_id and optional cursor and limit.")] JsonElement input,
        CancellationToken cancellationToken
